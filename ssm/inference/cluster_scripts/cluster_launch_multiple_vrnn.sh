...
# FIVO-AUX-SGR-WINDOW
export exp_tag='fivo-aux-sgr-window'
export use_sgr=1
export proposal_type='VRNN_FILTERING'
export proposal_structure='VRNN_FILTERING_RESQ'
...
export exp_tag='fivo-aux-sgr-encoded'
export use_sgr=1
export proposal_type='VRNN_SMOOTHING'
export proposal_structure='VRNN_SMOOTHING_RESQ'
...
export exp_tag='fivo-aux-sgr-window-temper'
export use_sgr=1
export proposal_type='VRNN_FILTERING'
export proposal_structure='VRNN_FILTERING_RESQ'
export tilt_type='SINGLE_WINDOW'
...
export exp_tag='fivo-aux-sgr-encoded-temper'
export use_sgr=1
export proposal_type='VRNN_SMOOTHING'
export proposal_structure='VRNN_SMOOTHING_RESQ'
export tilt_type='ENCODED'
